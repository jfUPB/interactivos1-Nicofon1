porfa porfa usa esto para el codigo que sea solo copiar y pegar, con eso la longitud de la pagina se reduce a mucho menos de la mitad y se vuelve menos agobiante ver tanta cosa
```
<details><summary> hola</summary>
texto
</details>
```
esto es un ejemplo con un pedaso de la actividad 3 de la unidad 5
